...
namespace FollowManager.Collections.Generic
{
    /// <summary>
        ...
        : CollectionBasedDictionary<TKey, TValue>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        ///   <see cref="T:FollowManager.Collections.Generic.ObservableDictionary`2" /> クラスの
        ///   新しいインスタンスを初期化します。
        /// </summary>
        ...
        ///   新しい <see cref="T:FollowManager.Collections.Generic.ObservableDictionary`2" /> に要素がコピーされた 
        ...
        /// <summary>
        ///   指定された引数を使用して、
        ///   <see cref="E:FollowManager.Collections.Generic.ObservableDictionary`2.PropertyChanged" /> イベントを発生させます。
        /// </summary>
        ...
        /// <summary>
        ///   指定された引数を使用して、
        ///   <see cref="E:FollowManager.Collections.Generic.ObservableDictionary`2.CollectionChanged" /> イベントを発生させます。
        /// </summary>
        ...
        /// <summary>
        ///   <see cref="T:FollowManager.Collections.Generic.ObservableDictionary`2" /> の指定したインデックスにある要素を削除します。
        /// </summary>
        ...
        /// <summary>
        ///   <see cref="T:FollowManager.Collections.Generic.ObservableDictionary`2" /> からすべての要素を削除します。
        /// </summary>
